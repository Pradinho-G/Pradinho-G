...
Meu objetivo é construir uma base sólida em tecnologia, explorar diferentes áreas de TI e me preparar para ingressar em uma graduação na área de tecnologia.
...
Site pessoal desenvolvido para apresentar meus projetos, conhecimentos e evolução na área de tecnologia.
...
**Química → Programação → Desenvolvimento Web → Projetos → Portfólio → TI**

Estou documentando minha evolução aqui no GitHub, criando projetos e aprendendo um pouco mais todos os dias.
